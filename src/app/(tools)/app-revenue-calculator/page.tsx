...
export default function AppRevenueCalculator() {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-12 p-8 bg-white dark:bg-zinc-900 rounded-3xl shadow-2xl border border-gray-100 dark:border-zinc-800">
      <h1 className="text-4xl md:text-5xl font-bold text-center b mb-10 text-primary-gradient">
